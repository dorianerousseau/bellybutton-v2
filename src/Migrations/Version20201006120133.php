 ...
 */
final class Version20201006120133 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE performance ADD id_user INT AUTO_INCREMENT NOT NULL, DROP id, ADD PRIMARY KEY (id_user)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE performance ADD id INT NOT NULL, DROP id_user');
